...
program_LDADD = $(LDADD)
am_test_series_OBJECTS = test_series.$(OBJEXT) series.$(OBJEXT)
test_series_OBJECTS = $(am_test_series_OBJECTS)
...
am__v_CCLD_1 = 
SOURCES = $(program_SOURCES) $(test_series_SOURCES)
DIST_SOURCES = $(program_SOURCES) $(test_series_SOURCES)
...
ACLOCAL = ${SHELL} '/home/nazarboyko/lab2/Devops/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/nazarboyko/lab2/Devops/missing' autoconf
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"program\" -DPACKAGE_TARNAME=\"program\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"program\ 1.0\" -DPACKAGE_BUGREPORT=\"nazar.bojko.2004@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"program\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/nazarboyko/lab2/Devops/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = program
PACKAGE_BUGREPORT = nazar.bojko.2004@gmail.com
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/nazarboyko/lab2/Devops
...
install_sh = ${SHELL} /home/nazarboyko/lab2/Devops/install-sh
...
test_series_SOURCES = test_series.cpp series.cpp
all: all-am
...
test_series$(EXEEXT): $(test_series_OBJECTS) $(test_series_DEPENDENCIES) $(EXTRA_test_series_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(CXXLINK) $(test_series_OBJECTS) $(test_series_LDADD) $(LIBS)
